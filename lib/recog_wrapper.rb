require "recog"
require "recog/matcher_factory.rb"
require "rubygems"
...
module Intrigue
  module Ident
    module RecogWrapper
      module Helpers
        @@recog_main_dir = Gem::Specification.find_by_name("recog").gem_dir
      ...
      module Dns
        ...
        def recog_match_dns_version(banner_string)
          ...
          matches = matcher.match_banner(banner_string)
      ...
      module Ftp
        ...
        def recog_match_ftp_banner(banner_string)
      ...
      module Http
        ...
        def recog_match_http_cookies(banner_string)
          options = OpenStruct.new(color: false,
                                   detail: true, fail_fast: false, multi_match: true)
          ndb = ::Recog::DB.new("http_cookies.xml"); nil
          options.fingerprints = ndb.fingerprints; nil
          matcher = ::Recog::MatcherFactory.build(options); nil
          matches = matcher.match_banner(banner_string.gsub("set-cookie:", "").strip)
      ...
      module Mysql
        ...
        def recog_match_mysql_error(banner_string)
          options = OpenStruct.new(color: false,
                                   detail: true, fail_fast: false, multi_match: true)
      ...
      module Pop3
        ...
        def recog_match_pop3_banner(banner_string)
          options = OpenStruct.new(color: false, detail: true, fail_fast: false, multi_match: true)
      ...
      module Smtp
        ...
        def recog_match_smtp_banner(banner_string)
          options = OpenStruct.new(color: false, detail: true, fail_fast: false, multi_match: true)
      ...
      module Snmp
        ...
        def recog_match_snmp_banner(banner_string)
          options = OpenStruct.new(color: false,
                                   detail: true, fail_fast: false, multi_match: true)
          ndb = ::Recog::DB.new("snmp_sysdescr.xml"); nil
          options.fingerprints = ndb.fingerprints; nil
          matcher = ::Recog::MatcherFactory.build(options); nil
          matches = matcher.match_banners(banner_string)
      ...
      module Ssh
        ...
        def recog_match_ssh_banner(banner_string)
          # require "pry"; binding.pry

          # Specify version number
          options = OpenStruct.new(color: false, detail: true, fail_fast: false, multi_match: true)
          banner_file = @@recog_main_dir + "/xml/ssh_banners.xml"
          ndb = ::Recog::DB.new(banner_file); nil
          options.fingerprints = ndb.fingerprints; nil
          matcher = ::Recog::MatcherFactory.build(options); nil
          require "pry"; binding.pry
          matches = matcher.match_banners(banner_string)
